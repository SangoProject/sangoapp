...
class RecordPageState extends State<RecordPage> {
  ...
  Future<void> _initDatabase() async {
    db = await openRecordDatabase('recorded_data.db');
  }
  ...
  // 매개변수가 넘어오면 그걸로 센터 잡기 만약 안넘어오면 그냥 현위치를 센터로
  // 위치 업데이트 시작
  ...
  // 지도 초기화 or 현위치 버튼 누를 시 현재 위치 가져오는 비동기 메서드
                ...
                Padding(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      Text(
                        '${(distanceTotal / 1000).toStringAsFixed(2)} km', // 미터를 킬로미터로 변환
                        style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold),
                      ),
                      TextButton(
                        onPressed: () async {
                      ...
                      Padding(
                        ...
                        child: ElevatedButton(
                          onPressed: () async {
                            ...
                            bool newIsRecording = !isRecording;
                            ...
                            if (newIsRecording) {
                              ...
                              await addRecord(db!, DateTime.now(), distanceTotal, formattedTime);
                            }
